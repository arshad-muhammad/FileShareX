      ...
      <header className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions" id="downloads">
            <a href="https://github.com/arshad-muhammad/FileShareX/releases/latest/download/FileShareX-Setup.exe" className="btn-primary" id="hero-primary-cta">
            ...
            <a href="https://github.com/arshad-muhammad/FileShareX/releases/latest/download/FileShareX.dmg" className="btn-secondary">
              <span>macOS (.dmg)</span>
            </a>
            <a href="https://github.com/arshad-muhammad/FileShareX/releases/latest/download/FileShareX.AppImage" className="btn-secondary">
      ...
      <section id="open-source" className="open-source">
        <div className="open-source-inner reveal" ref={addToReveals}>
          ...
          <div className="open-source-github">
            <a href="https://github.com/arshad-muhammad/FileShareX" target="_blank" rel="noopener noreferrer" class="github-showcase-card">
              <div className="github-card-header">
                ...
                <div className="github-card-titles">
                  <span class="repo-org">arshad-muhammad</span>
                  <span class="repo-name">FileShareX</span>
                </div>
              </div>
